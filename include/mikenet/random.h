...
float get_gaussian();   /* uses lookup table */
float gaussian_number();  /* computes it on the fly */
void init_gaussians();   /* sets up lookup table */
void set_gaussian_seed(int);  /* seed for lookup table */
